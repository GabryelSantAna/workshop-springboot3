...
import com.teste.couser.entities.Payment;
import com.teste.couser.entities.Product;
...
import com.teste.couser.repositories.OrderItemRepository;
import com.teste.couser.repositories.OrderRepository;
import com.teste.couser.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	@Autowired
	private ProductRepository productReoository;
	...
	public void run(String... args) throws Exception {
		...
		productReoository.saveAll(Arrays.asList(p1,p2,p3,p4,p5));
